...
namespace Task6
{
    ...
    public class CreateAndDeleteTest
    {
        ...
        public void CreateAndDeleteStudentsTest()
        {
            ...
            studentsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.StudentsRepository.Delete(o.Id)));
        ...
        public void CreateAndDeleteGroupsTest()
        {
            ...
            groupsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.GroupsRepository.Delete(o.Id)));
            bool isEqualCollections = isCreateAndDeleteList.Contains(false);
            Assert.IsTrue(!isEqualCollections);
        }
        ...
        public void CreateAndDeleteSubjectsTest()
        {
            ...
            subjectsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.SubjectsRepository.Delete(o.Id)));
            bool isEqualCollections = isCreateAndDeleteList.Contains(false);
            Assert.IsTrue(!isEqualCollections);
        }
        ...
        public void CreateAndDeleteSubjectsOfGroupsTest()
        {
            ...
            subjectsOfGroupsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.SubjectsOfGroupsRepository.Delete(o.Id)));
            bool isEqualCollections = isCreateAndDeleteList.Contains(false);
            Assert.IsTrue(!isEqualCollections);
        }
        ...
        public void CreateAndDeleteSessionsTest()
        {
            ...
            sessionsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.SessionsRepository.Delete(o.Id)));
            bool isEqualCollections = isCreateAndDeleteList.Contains(false);
            Assert.IsTrue(!isEqualCollections);
        }
        ...
        public void CreateAndDeleteExamsTest()
        {
            ...
            examsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.ExamsRepository.Delete(o.Id)));
            bool isEqualCollections = isCreateAndDeleteList.Contains(false);
            Assert.IsTrue(!isEqualCollections);
        }
        ...
        public void CreateAndDeleteResultsOfExamsTest()
        {
            ...
            resultsExamsCases.ForEach(o => isCreateAndDeleteList.Add(dbContext.ResultsOfExamsRepository.Delete(o.Id)));
            bool isEqualCollections = isCreateAndDeleteList.Contains(false);
            Assert.IsTrue(!isEqualCollections);
        }
    }
